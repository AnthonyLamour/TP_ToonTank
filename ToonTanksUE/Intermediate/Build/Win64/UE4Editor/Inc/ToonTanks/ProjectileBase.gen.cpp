...
// End Cross Module References
	DEFINE_FUNCTION(AProjectileBase::execOnHit)
	{
		...
		P_GET_STRUCT(FVector,Z_Param_NomalImpulse);
		P_GET_STRUCT_REF(FHitResult,Z_Param_Out_Hit);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnHit(Z_Param_HitComp,Z_Param_OtherActor,Z_Param_OtherComp,Z_Param_NomalImpulse,Z_Param_Out_Hit);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_AProjectileBase_OnHit_Statics
	{
		...
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_NomalImpulse;
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AProjectileBase_OnHit_Statics::NewProp_NomalImpulse = { "NomalImpulse", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ProjectileBase_eventOnHit_Parms, NomalImpulse), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AProjectileBase_OnHit_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AProjectileBase_OnHit_Statics::NewProp_NomalImpulse,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AProjectileBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AProjectileBase_OnHit, "OnHit" }, // 2770078355
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AProjectileBase, 3178645753);
